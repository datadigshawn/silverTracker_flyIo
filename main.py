    ...
    for attempt in range(max_retries):
        try:
            ...
            if resp.status_code == 200:
                ...
                print(f"⚠️ Telegram 發送失敗 (嘗試 {attempt+1}/{max_retries}): {resp.text[:100]}")
...
def monitoring_cycle(state, last_seen_links):
    ...
    shfe_usd = (current_shfe / rate) / 32.1507466
